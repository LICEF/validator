...
public class Validator
{
  ...
  private JDOMResult domValidator = null;

  /** generated xsl:messages from the preprocessor */
  private Vector warnings = new Vector();
  
  private TransformerFactory trsfactory = TransformerFactory.newInstance();
           ...
           ParserConfigurationException
  {
    Transformer validator =
      trsfactory.newTransformer(new JDOMSource(domValidator.getDocument()));
//    trsfactory.setURIResolver(new SchematronUriResolver());
